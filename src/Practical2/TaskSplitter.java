...
public class TaskSplitter extends TypedAtomicActor {
    ...
    public TaskSplitter(CompositeEntity container, String name) throws NameDuplicationException, IllegalActionException  {
